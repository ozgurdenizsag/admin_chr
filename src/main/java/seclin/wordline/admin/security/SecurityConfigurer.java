...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/recupererByLoginAndEmail/{login}/{email}").permitAll()
                .antMatchers(HttpMethod.GET,"/getUtilisateur").hasAnyAuthority(ROLE_ADMIN,ROLE_MANAGER)
                .antMatchers(HttpMethod.POST,"/addUtilisateur").hasAnyAuthority(ROLE_ADMIN,ROLE_MANAGER)
                .antMatchers(HttpMethod.GET,"/getUtilisateurById/{id}").hasAnyAuthority(ROLE_ADMIN,ROLE_MANAGER)
                .antMatchers(HttpMethod.DELETE,"/deleteUtilisateurById/{id}").hasAnyAuthority(ROLE_ADMIN,ROLE_MANAGER)
